...
// define('APP_PATH',$_SERVER['SERVER_NAME'].'/');



// 自定义常量
define('CYR_PATH',pc_base::load_config('system','cyr_path'));// 自定义静态文件地址

define('PC1_PATH',pc_base::load_config('system','pc1_path'));
define('M1_PATH',pc_base::load_config('system','m1_path'));
