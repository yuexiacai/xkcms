...
<div class="main">
	<div class="col-left">
    	<div class="crumbs"><a href="<?php echo siteurl($siteid);?>">首页</a><span> &gt; </span><a href="<?php echo APP_PATH;?>index.php?m=formguide&c=index&a=index">表单向导</a> <span> &gt; </span> <?php echo $name;?></div>
        <div id="Article">
        	<h1><?php echo $name;?></h1>
			<div class="content">
